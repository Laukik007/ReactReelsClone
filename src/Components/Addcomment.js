...
function Addcomment({ userData, postData }) {
  ...
  return (
    <div style={{ width: '100%' }} >
      <TextField id="outlined-basic" label="Comment" variant="outlined" size="small" sx={{ width: '74%' }} value={text} onChange={(e) => setText(e.target.value)} onKeyPress={handleKeyboard} />
